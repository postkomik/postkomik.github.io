...
#
# Example:
#   ./genre.sh -c How to replace strings with sed
#
# Important Notes:
...
echo "genre-name: ${POST_NAME}"
echo "category: genre"
echo "author: Postkomik"
echo "description: baca komik terbaru genre ${POST_NAME} di postkomik"
echo "permalink: /genre/${POST_NAME}"
echo "---"
