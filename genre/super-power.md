...
subtitle: Super Power
genre-name: super-power
category: genre
author: Postkomik
description: baca komik terbaru genre super-power di postkomik
permalink: /genre/super-power
---

{% for page in site.pages %}
{% if page.genre contains 'super-power' %}
